window.Test = {
    ...
    addQuestionGivenAnswer: function (id,givenAnswer) {
        ...
        $.ajax({
            ...
            //removes all previous color classes
            // for (i = 1; i <= 3; i++) {
            //     $("#add_given_answer_" + response.id + "_" + i).removeClass("right_answer");
            //     $("#add_given_answer_" + response.id + "_" + i).removeClass("wrong_answer");
            // }
